    ...
    return (
      ...
      <Container>
        ...
        <Content>
            ...
            <Text>Bridging Loan Perusahaan</Text>
                </TouchableOpacity>
                </View>
              </Left>
              <Right>
            ...
            <Left>
                <View style={{ flexDirection:'column', justifyContent:'flex-start'}}>
                <TouchableOpacity onPress={()=>this.props.navigation.navigate('Profile')}>
          <Text style={{alignSelf:'flex-start'}}>Rekening Koran Perusahaan</Text>
                </TouchableOpacity>
                </View>
              </Left>
              <Right>
            ...
            <Left>
                <View style={{ flexDirection:'column', justifyContent:'flex-start'}}>
                <TouchableOpacity onPress={()=>this.props.navigation.navigate('Profile')}>
          <Text>Kredit Investasi Perusahaan</Text>
                </TouchableOpacity>
                </View>
              </Left>
              <Right>
            ...
            <Left>
                <View style={{ flexDirection:'column', justifyContent:'flex-start'}}>
                <TouchableOpacity onPress={()=>this.props.navigation.navigate('Profile')}>
          <Text>Take Over Perusahaan</Text>
                </TouchableOpacity>
                </View>
              </Left>
              <Right>
